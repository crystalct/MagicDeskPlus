...
/* from c64cart.c */
extern int
    mem_cartridge_type; /* Type of the cartridge attached. ("Main Slot") */

/* from c64cartmem.c */
extern export_t export_slot1;
extern export_t export_slotmain;
extern export_t export_passthrough; /* slot1 and main combined, goes into slot0
                                       passthrough or c64 export */

/*
    TODO: keep in sync with cartridge.h (currently highest:
   CARTRIDGE_DIASHOW_MAKER)
    TODO: keep -cartXYZ options in sync with cartconv -t option

    the following carts, which do not have any rom or ram, are NOT in the list
...
static const cmdline_option_t cmdline_options[] = {
    /* generic cartridges */
    {"-cart8", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_GENERIC_8KB, NULL, NULL, "<Name>",
     "Attach raw 8KiB cartridge image"},
    {"-cart16", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_GENERIC_16KB, NULL, NULL, "<Name>",
     "Attach raw 16KiB cartridge image"},
    {"-cartultimax", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS,
     cart_attach_cmdline, (void *)CARTRIDGE_ULTIMAX, NULL, NULL, "<Name>",
     "Attach generic 16KiB Ultimax cartridge image"},
    /* smart-insert CRT */
    {"-cartcrt", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_CRT, NULL, NULL, "<Name>", "Attach CRT cartridge image"},
    /* binary images: */
    {"-cartap", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_ATOMIC_POWER, NULL, NULL, "<Name>",
     "Attach raw 32KiB Atomic Power cartridge image"},
    {"-cartar2", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_ACTION_REPLAY2, NULL, NULL, "<Name>",
     "Attach raw 16KiB Action Replay MK2 cartridge image"},
    {"-cartar3", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_ACTION_REPLAY3, NULL, NULL, "<Name>",
     "Attach raw 16KiB Action Replay MK3 cartridge image"},
    {"-cartar4", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_ACTION_REPLAY4, NULL, NULL, "<Name>",
     "Attach raw 32KiB Action Replay MK4 cartridge image"},
    {"-cartar5", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_ACTION_REPLAY, NULL, NULL, "<Name>",
     "Attach raw 32KiB Action Replay cartridge image"},
    {"-cartbb3", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_BLACKBOX3, NULL, NULL, "<Name>",
     "Attach raw 8KiB " CARTRIDGE_NAME_BLACKBOX3 " cartridge image"},
    {"-cartbb4", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_BLACKBOX4, NULL, NULL, "<Name>",
     "Attach raw 16KiB " CARTRIDGE_NAME_BLACKBOX4 " cartridge image"},
    {"-cartbb8", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_BLACKBOX8, NULL, NULL, "<Name>",
     "Attach raw 32/64KiB " CARTRIDGE_NAME_BLACKBOX8 " cartridge image"},
    {"-cartbb9", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_BLACKBOX9, NULL, NULL, "<Name>",
     "Attach raw 32KiB " CARTRIDGE_NAME_BLACKBOX9 " cartridge image"},
    {"-cartbdt", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_BMPDATATURBO, NULL, NULL, "<Name>",
     "Attach raw 16KiB " CARTRIDGE_NAME_BMPDATATURBO " cartridge image"},
    {"-cartbis", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_BISPLUS, NULL, NULL, "<Name>",
     "Attach raw 2/4/8KiB " CARTRIDGE_NAME_BISPLUS " cartridge image"},
    {"-cartcap", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_CAPTURE, NULL, NULL, "<Name>",
     "Attach raw 8KiB Capture cartridge image"},
    {"-cartcomal", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_COMAL80, NULL, NULL, "<Name>",
     "Attach raw 64KiB Comal 80 cartridge image"},
    {"-cartdep256", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS,
     cart_attach_cmdline, (void *)CARTRIDGE_DELA_EP256, NULL, NULL, "<Name>",
     "Attach raw Dela EP256 cartridge image"},
    {"-cartdep64", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_DELA_EP64, NULL, NULL, "<Name>",
     "Attach raw Dela EP64 cartridge image"},
    {"-cartdep7x8", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS,
     cart_attach_cmdline, (void *)CARTRIDGE_DELA_EP7x8, NULL, NULL, "<Name>",
     "Attach raw Dela EP7x8 cartridge image"},
    {"-cartdin", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_DINAMIC, NULL, NULL, "<Name>",
     "Attach raw 128KiB Dinamic cartridge image"},
    {"-cartdsm", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_DIASHOW_MAKER, NULL, NULL, "<Name>",
     "Attach raw 8KiB Diashow-Maker cartridge image"},
    {"-cartdqbb", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_DQBB, NULL, NULL, "<Name>",
     "Attach raw 16KiB Double Quick Brown Box cartridge image"},
    {"-cartdrean", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_DREAN, NULL, NULL, "<Name>",
     "Attach raw 32KiB " CARTRIDGE_NAME_DREAN " cartridge image"},
    {"-carteasy", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_EASYFLASH, NULL, NULL, "<Name>",
     "Attach raw EasyFlash cartridge image"},
    {"-carteasycalc", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS,
     cart_attach_cmdline, (void *)CARTRIDGE_EASYCALC, NULL, NULL, "<Name>",
     "Attach raw 24KiB Easy Calc Result cartridge image"},
    /* omitted: CARTRIDGE_EASYFLASH_XBANK (NO CART EXISTS!) */
    {"-cartepyx", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_EPYX_FASTLOAD, NULL, NULL, "<Name>",
     "Attach raw 8KiB Epyx FastLoad cartridge image"},
    {"-cartexos", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_EXOS, NULL, NULL, "<Name>",
     "Attach raw 8KiB EXOS cartridge image"},
    {"-cartexpert", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS,
     cart_attach_cmdline, (void *)CARTRIDGE_EXPERT, NULL, NULL, "<Name>",
     "Attach raw 8KiB Expert Cartridge image"},
    {"-cartf64", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_FORMEL64, NULL, NULL, "<Name>",
     "Attach raw 32KiB Formel 64 image"},
    {"-cartfc1", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_FINAL_I, NULL, NULL, "<Name>",
     "Attach raw 16KiB Final Cartridge image"},
    {"-cartfc3", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_FINAL_III, NULL, NULL, "<Name>",
     "Attach raw 64KiB Final Cartridge III image"},
    {"-cartfcplus", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS,
     cart_attach_cmdline, (void *)CARTRIDGE_FINAL_PLUS, NULL, NULL, "<Name>",
     "Attach raw 32KiB Final Cartridge Plus image"},
    {"-cartff", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_FREEZE_FRAME, NULL, NULL, "<Name>",
     "Attach raw 8KiB Freeze Frame image"},
    {"-cartff2", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_FREEZE_FRAME_MK2, NULL, NULL, "<Name>",
     "Attach raw 16KiB Freeze Frame MK2/MK3 image"},
    {"-cartfm", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_FREEZE_MACHINE, NULL, NULL, "<Name>",
     "Attach raw 32KiB Freeze Machine image"},
    {"-cartfp", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_FUNPLAY, NULL, NULL, "<Name>",
     "Attach raw 128KiB Fun Play/Power Play cartridge image"},
    {"-cartgmod2", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_GMOD2, NULL, NULL, "<Name>",
     "Attach raw GMod2 cartridge image"},
    {"-cartgmod3", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_GMOD3, NULL, NULL, "<Name>",
     "Attach raw GMod2 cartridge image"},
    {"-cartgk", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_GAME_KILLER, NULL, NULL, "<Name>",
     "Attach raw 8KiB Game Killer cartridge image"},
    {"-cartgeoram", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS,
     cart_attach_cmdline, (void *)CARTRIDGE_GEORAM, NULL, NULL, "<Name>",
     "Attach raw GEO-RAM cartridge image"},
    {"-cartgs", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_GS, NULL, NULL, "<Name>",
     "Attach raw 512KiB Game System cartridge image"},
    {"-carthyper", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_HYPERBASIC, NULL, NULL, "<Name>",
     "Attach raw 64KiB " CARTRIDGE_NAME_HYPERBASIC " cartridge image"},
    {"-cartide64", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_IDE64, NULL, NULL, "<Name>",
     "Attach raw 64KiB IDE64 cartridge image"},
    {"-cartieee", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_IEEE488, NULL, NULL, "<Name>",
     "Attach IEEE-488 Interface cartridge image"},
    {"-cartieeeflash64", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS,
     cart_attach_cmdline, (void *)CARTRIDGE_IEEEFLASH64, NULL, NULL, "<Name>",
     "Attach raw 8KiB IEEE Flash! 64 cartridge image"},
    {"-cartisepic", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS,
     cart_attach_cmdline, (void *)CARTRIDGE_ISEPIC, NULL, NULL, "<Name>",
     "Attach raw 2KiB ISEPIC cartridge image"},
    {"-cartkcs", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_KCS_POWER, NULL, NULL, "<Name>",
     "Attach raw 16KiB KCS Power cartridge image"},
    {"-cartks", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_KINGSOFT, NULL, NULL, "<Name>",
     "Attach raw 24KiB Kingsoft cartridge image"},
    {"-cartltk", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_LT_KERNAL, NULL, NULL, "<Name>",
     "Attach raw 8kB Lt. Kernal boot image"},
    {"-cartmach5", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_MACH5, NULL, NULL, "<Name>",
     "Attach raw 8KiB MACH 5 cartridge image"},
    {"-cartmd", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_MAGIC_DESK, NULL, NULL, "<Name>",
     "Attach raw 32/64/128KiB Magic Desk cartridge image"},
    {"-cartmd16", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_MAGIC_DESK_16, NULL, NULL, "<Name>",
     "Attach raw up to 2048KiB Magic Desk 16K cartridge image"},
    {"-cartmb", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_MEGABYTER, NULL, NULL, "<Name>",
     "Attach raw 1024KiB " CARTRIDGE_NAME_MEGABYTER " cartridge image"},
    {"-cartmf", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_MAGIC_FORMEL, NULL, NULL, "<Name>",
     "Attach raw Magic Formel cartridge image"},
    {"-cartmax", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_MAX_BASIC, NULL, NULL, "<Name>",
     "Attach raw MAX Basic cartridge image"},
    {"-cartmikro", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_MIKRO_ASSEMBLER, NULL, NULL, "<Name>",
     "Attach raw 8KiB Mikro Assembler cartridge image"},
    {"-cartmmc64", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_MMC64, NULL, NULL, "<Name>",
     "Attach raw 8KiB MMC64 cartridge image"},
    {"-cartmmcr", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_MMC_REPLAY, NULL, NULL, "<Name>",
     "Attach raw 512KiB MMC Replay cartridge image"},
    {"-cartmv", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_MAGIC_VOICE, NULL, NULL, "<Name>",
     "Attach raw 16KiB Magic Voice cartridge image"},
    {"-cartmm", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_MULTIMAX, NULL, NULL, "<Name>",
     "Attach raw 1MiB " CARTRIDGE_NAME_MULTIMAX " cartridge image"},
    {"-cartocean", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_OCEAN, NULL, NULL, "<Name>",
     "Attach raw Ocean cartridge image"},
    {"-cartpf", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_PAGEFOX, NULL, NULL, "<Name>",
     "Attach raw 64KiB Pagefox cartridge image"},
    {"-cartp64", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_P64, NULL, NULL, "<Name>",
     "Attach raw 256KiB Prophet 64 cartridge image"},
    {"-cartpartner64", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS,
     cart_attach_cmdline, (void *)CARTRIDGE_PARTNER64, NULL, NULL, "<Name>",
     "Attach raw 16KiB " CARTRIDGE_NAME_PARTNER64 " cartridge image"},
    {"-cartpd", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_PROFIDOS, NULL, NULL, "<Name>",
     "Attach raw 16KiB " CARTRIDGE_NAME_PROFIDOS " cartridge image"},
    {"-cartramcart", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS,
     cart_attach_cmdline, (void *)CARTRIDGE_RAMCART, NULL, NULL, "<Name>",
     "Attach raw RamCart cartridge image"},
    {"-cartramlink", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS,
     cart_attach_cmdline, (void *)CARTRIDGE_RAMLINK, NULL, NULL, "<Name>",
     "Attach raw 64KiB RAMLink ROM image"},
    {"-cartreu", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_REU, NULL, NULL, "<Name>",
     "Attach raw REU cartridge image"},
    {"-cartrep256", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS,
     cart_attach_cmdline, (void *)CARTRIDGE_REX_EP256, NULL, NULL, "<Name>",
     "Attach raw REX EP256 cartridge image"},
    {"-cartrrf", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_REX_RAMFLOPPY, NULL, NULL, "<Name>",
     "Attach raw " CARTRIDGE_NAME_REX_RAMFLOPPY " cartridge image"},
    {"-cartrgcd", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_RGCD, NULL, NULL, "<Name>",
     "Attach raw 64KiB RGCD cartridge image"},
    {"-cartuc1", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_UC1, NULL, NULL, "<Name>",
     "Attach raw 32/64/128KiB UC-1 cartridge image"},
    {"-cartuc15", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_UC15, NULL, NULL, "<Name>",
     "Attach raw 128/256/512KiB UC-1.5 cartridge image"},
    {"-cartuc2", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_UC2, NULL, NULL, "<Name>",
     "Attach raw 128/256/512KiB UC-2 cartridge image"},
#ifdef HAVE_RAWNET
    {"-cartrrnet", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_RRNETMK3, NULL, NULL, "<Name>",
     "Attach raw 8KiB RR-Net MK3 cartridge image"},
#endif
    {"-cartross", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_ROSS, NULL, NULL, "<Name>",
     "Attach raw 16/32KiB ROSS cartridge image"},
    {"-cartrr", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_RETRO_REPLAY, NULL, NULL, "<Name>",
     "Attach raw 64KiB Retro Replay cartridge image"},
    {"-cartru", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_REX, NULL, NULL, "<Name>",
     "Attach raw 8KiB REX Utility cartridge image"},
    {"-cartsdbox", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_SDBOX, NULL, NULL, "<Name>",
     "Attach raw 128KiB " CARTRIDGE_NAME_SDBOX " cartridge image"},
    {"-carts64", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_SNAPSHOT64, NULL, NULL, "<Name>",
     "Attach raw 4KiB Snapshot 64 cartridge image"},
    {"-cartsb", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_STRUCTURED_BASIC, NULL, NULL, "<Name>",
     "Attach raw Structured Basic cartridge image"},
    {"-cartse5", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_SUPER_EXPLODE_V5, NULL, NULL, "<Name>",
     "Attach raw 16KiB Super Explode V5 cartridge image"},
    {"-cartsg", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_SUPER_GAMES, NULL, NULL, "<Name>",
    ...
    {"-cartsimon", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_SIMONS_BASIC, NULL, NULL, "<Name>",
     "Attach raw 16KiB Simons Basic cartridge image"},
    {"-cartss4", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_SUPER_SNAPSHOT, NULL, NULL, "<Name>",
     "Attach raw 32KiB Super Snapshot V4 cartridge image"},
    {"-cartss5", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_SUPER_SNAPSHOT_V5, NULL, NULL, "<Name>",
     "Attach raw 64KiB or 128KiB Super Snapshot V5 cartridge image"},
    {"-cartstar", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_STARDOS, NULL, NULL, "<Name>",
    ...
    {"-cartturtle", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS,
     ...
     "<Name>",
     "Attach raw 16KiB " CARTRIDGE_NAME_TURTLE_GRAPHICS_II " cartridge image"},
    {"-cartwl", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_WESTERMANN, NULL, NULL, "<Name>",
     "Attach raw 16KiB Westermann Learning cartridge image"},
    {"-cartws", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_WARPSPEED, NULL, NULL, "<Name>",
     "Attach raw 16KiB " CARTRIDGE_NAME_WARPSPEED " cartridge image"},
    {"-cartzaxxon", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS,
     cart_attach_cmdline, (void *)CARTRIDGE_ZAXXON, NULL, NULL, "<Name>",
     "Attach raw 16KiB Zaxxon cartridge image"},
    {"-cartzipp", CALL_FUNCTION, CMDLINE_ATTRIB_NEED_ARGS, cart_attach_cmdline,
     (void *)CARTRIDGE_ZIPPCODE48, NULL, NULL, "<Name>",
     "Attach raw 8KiB " CARTRIDGE_NAME_ZIPPCODE48 " cartridge image"},
    CMDLINE_LIST_END};

int cart_cmdline_options_init(void) {
  /* "Slot 0" */
  if (mmc64_cmdline_options_init() < 0 ||
      magicvoice_cmdline_options_init() < 0 || tpi_cmdline_options_init() < 0 ||
      ramlink_cmdline_options_init() < 0
      /* "Slot 1" */
      || dqbb_cmdline_options_init() < 0 || expert_cmdline_options_init() < 0 ||
      isepic_cmdline_options_init() < 0 || ramcart_cmdline_options_init() < 0
  /* "I/O Slot" */
#ifdef HAVE_MIDI
      ...
      georam_cmdline_options_init() < 0 || reu_cmdline_options_init() < 0 ||
      ...
      gmod2_cmdline_options_init() < 0 || gmod3_cmdline_options_init() < 0 ||
      ...
      magicdesk_cmdline_options_init() < 0 ||
      retroreplay_cmdline_options_init() < 0 ||
      rexramfloppy_cmdline_options_init() < 0 || rgcd_cmdline_options_init() < 0
#ifdef HAVE_RAWNET
...
int cart_resources_init(void) {
  /* "Slot 0" */
  if (mmc64_resources_init() < 0 || magicvoice_resources_init() < 0 ||
      tpi_resources_init() < 0 || ramlink_resources_init() < 0 ||
      ieeeflash64_resources_init() < 0
      /* "Slot 1" */
      || expert_resources_init() < 0 || dqbb_resources_init() < 0 ||
      isepic_resources_init() < 0 ||
      ramcart_resources_init() < 0
      /* "IO Slot" */
      || digimax_resources_init() < 0 || ds12c887rtc_resources_init() < 0 ||
      georam_resources_init() < 0
#ifdef HAVE_MIDI
      || c64_midi_resources_init() < 0
#endif
      || reu_resources_init() < 0 || sfx_soundexpander_resources_init() < 0 ||
...
#endif
      /* "Main Slot" */
      || comal80_resources_init() < 0 || easyflash_resources_init() < 0 ||
      gmod2_resources_init() < 0 || gmod3_resources_init() < 0 ||
      ide64_resources_init() < 0 || ltkernal_resources_init() < 0 ||
      megabyter_resources_init() < 0 || mmcreplay_resources_init() < 0 ||
      magicdesk_resources_init() < 0 || retroreplay_resources_init() < 0 ||
      rexramfloppy_resources_init() < 0 || rgcd_resources_init() < 0
#ifdef HAVE_RAWNET
...
static int slot0conflicts[] = {CARTRIDGE_IEEE488, CARTRIDGE_IEEEFLASH64,
                               CARTRIDGE_MAGIC_VOICE, CARTRIDGE_MMC64, 0};

/* only one of the "Slot 1" carts can be enabled at a time */
static int slot1conflicts[] = {CARTRIDGE_EXPERT, CARTRIDGE_ISEPIC,
                               CARTRIDGE_DQBB, CARTRIDGE_RAMCART, 0};
      ...
      while (*list != 0) {
        if (*list != type) {
          if (cartridge_type_enabled(*list)) {
            DBG(("CART: detach conflicting cart: %d (only one Slot 0 cart can "
                 "be active)",
                 *list));
...
void cartridge_init_config(void) {
  if ((machine_class == VICE_MACHINE_C128) &&
      CARTRIDGE_C128_ISID(mem_cartridge_type)) {
...
int cartridge_can_flush_secondary_image(int crtid) {
  ...
  case CARTRIDGE_MAGIC_DESK:
    return magicdesk_can_flush_sram();
  case CARTRIDGE_MMC_REPLAY:
...
int cartridge_can_save_secondary_image(int crtid) {
  ...
  case CARTRIDGE_GMOD2:
    return 1;
  case CARTRIDGE_MAGIC_DESK:
    return magicdesk_can_save_sram();
  case CARTRIDGE_MMC_REPLAY:
    return 1;
  case CARTRIDGE_REX_RAMFLOPPY:
    return 1;
...
int cartridge_can_flush_tertiary_image(int crtid) {
  ...
  switch (crtid) {
  case CARTRIDGE_MAGIC_DESK:
    return magicdesk_can_flush_eeprom();
  }
...
int cartridge_can_save_tertiary_image(int crtid) {
  ...
  switch (crtid) {
  case CARTRIDGE_MAGIC_DESK:
    return magicdesk_can_save_eeprom();
  }
...
int cartridge_flush_secondary_image(int type) {
  ...
  case CARTRIDGE_MAGIC_DESK:
    return magicdesk_sram_flush();
  case CARTRIDGE_MMC_REPLAY:
    return mmcreplay_flush_eeprom();
  case CARTRIDGE_REX_RAMFLOPPY:
    return rexramfloppy_ram_flush();
  }
  log_error(LOG_DEFAULT, "Failed flushing secondary image for cartridge ID %d.",
            type);
  return -1;
}
...
int cartridge_flush_tertiary_image(int type) {
  switch (type) {
  case CARTRIDGE_MAGIC_DESK:
    return magicdesk_eeprom_flush();
  }
  log_error(LOG_DEFAULT, "Failed flushing tertiary image for cartridge ID %d.",
            type);
  return -1;
}
...
/*
    ...
    *atleast* all carts whose image might be modified at runtime should be
   hooked up here.
...
int cartridge_bin_save(int type, const char *filename) {
  ...
  log_error(LOG_DEFAULT,
            "Failed saving binary cartridge image for cartridge ID %d.\n",
            type);
  return -1;
}
...
int cartridge_save_secondary_image(int type, const char *filename) {
  ...
  case CARTRIDGE_MAGIC_DESK:
    return magicdesk_sram_save(filename);
  case CARTRIDGE_MMC_REPLAY:
...
int cartridge_save_tertiary_image(int type, const char *filename) {
  switch (type) {
  case CARTRIDGE_MAGIC_DESK:
    return magicdesk_eeprom_save(filename);
  }
  log_error(LOG_DEFAULT, "Failed saving tertiary image for cartridge ID %d.\n",
            type);
  return -1;
}
...
int cartridge_crt_save(int type, const char *filename) {
  ...
  log_error(LOG_DEFAULT,
            "Failed saving .crt cartridge image for cartridge ID %d.", type);
  return -1;
}
...
/* Perform MMU translation for simple cartridge RAM/ROM/FLASH mappings.
   ...
   - side effects should happen when the area is accessed (e.g. capacitor
   discharge, i/o area)
   - the memory area is programmable flash and it's not in it's "idle" mode now

   TODO: add more cartridges
*/
void cartridge_mmu_translate(unsigned int addr, uint8_t **base, int *start,
                             int *limit) {
  ...
  /* "Slot 0" */
  if (mmc64_cart_enabled()) {
    if ((res = mmc64_mmu_translate(addr, base, start, limit)) ==
        CART_READ_VALID) {
      return;
    }
  } else if (magicvoice_cart_enabled()) {
    if ((res = magicvoice_mmu_translate(addr, base, start, limit)) ==
        CART_READ_VALID) {
      return;
    }
  } else if (tpi_cart_enabled()) {
    if ((res = tpi_mmu_translate(addr, base, start, limit)) ==
        CART_READ_VALID) {
      return;
    }
  } else if (ieeeflash64_cart_enabled()) {
    if ((res = ieeeflash64_mmu_translate(addr, base, start, limit)) ==
        CART_READ_VALID) {
      return;
    }
  } else if (ramlink_cart_enabled()) {
    if ((res = ramlink_mmu_translate(addr, base, start, limit)) ==
        CART_READ_VALID) {
      return;
    }
  }
  ...
  case CARTRIDGE_SUPER_SNAPSHOT_V5:
    ...
    return;
  case CARTRIDGE_EPYX_FASTLOAD: /* must go through roml_read to discharge
                                   capacitor */
...
/* C64CART 0.1 snapshot module format:
   ...
   DWORD | reserved                         |
   DWORD | reserved                         |
   ARRAY | cart ids                         | <num cart> IDs of active
   cartridges
...
int cartridge_snapshot_write_modules(struct snapshot_s *s) {
  ...
  m = snapshot_module_create(s, SNAP_MODULE_NAME, C64CART_DUMP_VER_MAJOR,
                             C64CART_DUMP_VER_MINOR);
  if (m == NULL) {
    return -1;
  }
  ...
  if (0 || SMW_DW(m, (uint32_t)mem_cartridge_type) < 0 ||
      SMW_B(m, export.game) < 0 || SMW_B(m, export.exrom) < 0 ||
      SMW_DW(m, (uint32_t)romh_bank) < 0 ||
      SMW_DW(m, (uint32_t)roml_bank) < 0 || SMW_B(m, (uint8_t)export_ram) < 0 ||
      SMW_B(m, export.ultimax_phi1) < 0 || SMW_B(m, export.ultimax_phi2) < 0 ||
      SMW_CLOCK(m, cart_freeze_alarm_time) < 0 ||
      SMW_CLOCK(m, cart_nmi_alarm_time) < 0 ||
      SMW_B(m, export_slot1.game) < 0 || SMW_B(m, export_slot1.exrom) < 0 ||
      ...
      || SMW_DW(m, 0) < 0 || SMW_DW(m, 0) < 0 || SMW_DW(m, 0) < 0 ||
      SMW_DW(m, 0) < 0) {
    goto fail;
  }
  ...
  for (i = 0; i < number_of_carts; i++) {
    ...
    if ((machine_class == VICE_MACHINE_C128) &&
        CARTRIDGE_C128_ISID(cart_ids[i])) {
...
int cartridge_snapshot_read_modules(struct snapshot_s *s) {
  ...
  if ((vmajor != C64CART_DUMP_VER_MAJOR) ||
      (vminor != C64CART_DUMP_VER_MINOR)) {
    goto fail;
  }
  ...
  if (number_of_carts > C64CART_DUMP_MAX_CARTS) {
    DBG(("CART snapshot read: carts %i > max %i", number_of_carts,
         C64CART_DUMP_MAX_CARTS));
    goto fail;
  }

  /* Read "global" cartridge things */
  if (0 || SMR_DW_INT(m, &mem_cartridge_type) < 0 ||
      SMR_B(m, &export.game) < 0 || SMR_B(m, &export.exrom) < 0 ||
      SMR_DW_INT(m, &romh_bank) < 0 || SMR_DW_INT(m, &roml_bank) < 0 ||
      SMR_B_INT(m, &export_ram) < 0 || SMR_B(m, &export.ultimax_phi1) < 0 ||
      SMR_B(m, &export.ultimax_phi2) < 0 ||
      SMR_CLOCK(m, &cart_freeze_alarm_time) < 0 ||
      SMR_CLOCK(m, &cart_nmi_alarm_time) < 0 ||
      SMR_B(m, &export_slot1.game) < 0 || SMR_B(m, &export_slot1.exrom) < 0 ||
      ...
      /* some room for future expansion */
      || SMR_DW(m, &dummy) < 0 || SMR_DW(m, &dummy) < 0 ||
      SMR_DW(m, &dummy) < 0 || SMR_DW(m, &dummy) < 0) {
    goto fail;
  }
