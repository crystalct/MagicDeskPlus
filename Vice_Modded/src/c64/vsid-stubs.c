...
static drive_type_info_t drive_dummy_list[] = {{NULL, -1}};
...
int drive_check_expansion2000(int type) { return 0; }

int drive_check_expansion4000(int type) { return 0; }

int drive_check_expansion6000(int type) { return 0; }

int drive_check_expansion8000(int type) { return 0; }

int drive_check_expansionA000(int type) { return 0; }

int drive_check_dolphindos3(int type) { return 0; }

int drive_check_profdos(int type) { return 0; }

int drive_check_stardos(int type) { return 0; }

int drive_check_supercard(int type) { return 0; }

int drive_check_rtc(int type) { return 0; }

int drive_check_iec(int type) { return 0; }
...
int cartridge_attach_image(int type, const char *filename) { return -1; }

int cartridge_attach_add_image(int type, const char *filename) { return -1; }

void cartridge_detach_image(int type) {}

uint8_t *ultimax_romh_phi1_ptr(uint16_t addr) { return mem_phi; }

uint8_t *ultimax_romh_phi2_ptr(uint16_t addr) { return mem_phi; }

int cartridge_save_image(int type, const char *filename) { return -1; }

int cartridge_save_secondary_image(int type, const char *filename) {
  return -1;
}
int cartridge_flush_image(int type) { return -1; }

int cartridge_flush_secondary_image(int type) { return -1; }

int cartridge_flush_tertiary_image(int type) { return -1; }
int cartridge_save_tertiary_image(int type, const char *filename) { return -1; }
int cartridge_can_flush_tertiary_image(int crtid) { return 0; }
int cartridge_can_save_tertiary_image(int crtid) { return 0; }

int cartridge_can_save_image(int crtid) { return 0; }

int cartridge_can_flush_image(int crtid) { return 0; }

int cartridge_can_save_secondary_image(int crtid) { return 0; }

int cartridge_can_flush_secondary_image(int crtid) { return 0; }

int cartridge_enable(int crtid) { return -1; }

int cartridge_disable(int crtid) { return -1; }

int cartridge_type_enabled(int crtid) { return 0; }

void cartridge_set_default(void) {}

void cartridge_unset_default(void) {}

cartridge_info_t *cartridge_get_info_list(void) { return NULL; }

/* return cartridge type of main slot
   returns 0 (CARTRIDGE_CRT) if crt file */
int cartridge_get_id(int slot) { return CARTRIDGE_NONE; }

char *cartridge_get_filename_by_slot(int slot) { return NULL; }

void cartridge_trigger_freeze(void) {}

midi_interface_t midi_interface[] = {MIDI_INFERFACE_LIST_END};
...
gfxoutputdrv_format_t ffmpegdrv_formatlist[] = {{NULL, NULL, NULL, 0}};
...
rtc_ds1216e_t *ds1216e_init(char *device) { return NULL; }

/* FIXME: this stub can be removed once the drive code has been stubbed */
void ds1216e_destroy(rtc_ds1216e_t *context, int save) {}

uint8_t ds1216e_read(rtc_ds1216e_t *context, uint16_t address,
                     uint8_t origbyte) {
  return 0;
}

rtc_ds1202_1302_t *ds1202_1302_init(char *device, int rtc_type) { return NULL; }

void ds1202_1302_set_lines(rtc_ds1202_1302_t *context, unsigned int ce_line,
                           unsigned int sclk_line, unsigned int input_bit) {}

uint8_t ds1202_1302_read_data_line(rtc_ds1202_1302_t *context) { return 1; }
...
int ds1602_write_snapshot(rtc_ds1602_t *context, snapshot_t *s) { return -1; }

void ds1602_destroy(rtc_ds1602_t *context, int save) {}

rtc_ds1602_t *ds1602_init(char *device, time_t offset0) { return NULL; }

uint8_t ds1602_read_data_line(rtc_ds1602_t *context) { return 0; }
...
int ds1602_read_snapshot(rtc_ds1602_t *context, snapshot_t *s) { return -1; }
...
int tape_tap_attached(int port) { return 0; }
...
int tap_seek_start(tap_t *tap) { return 0; }
...
int tape_snapshot_read_module(int port, snapshot_t *s) { return 0; }

int tape_read(tape_image_t *tape_image, uint8_t *buf, size_t size) { return 0; }

tape_file_record_t *tape_get_current_file_record(tape_image_t *tape_image) {
  return NULL;
}

int tape_image_open(tape_image_t *tape_image) { return -1; }

int tape_image_close(tape_image_t *tape_image) { return 0; }
...
int tape_seek_to_next_file(tape_image_t *tape_image,
                           unsigned int allow_rewind) {
  return -1;
}

unsigned long tape_get_offset(tape_image_t *tape_image) { return -1; }

void tape_get_header(tape_image_t *tape_image, uint8_t *name) {}

const char *tape_get_file_name(int port) { return NULL; }

int tapeport_valid_port(int port) { return 0; }

/*****************************************************************************
 *  tapecart                                                                 *
 ****************************************************************************/

int tapecart_is_valid(const char *filename) { return 0; /* FALSE */ }

int tapecart_attach_tcrt(const char *filename, void *unused) { return -1; }

int tapecart_flush_tcrt(void) { return -1; }

/*******************************************************************************
    imagecontents
*******************************************************************************/

image_contents_screencode_t *
image_contents_to_screencode(image_contents_t *contents) {
  return NULL;
}
...
image_contents_t *tapecontents_read(const char *file_name) { return NULL; }
...
unsigned int fileio_get_bytes_left(fileio_info_t *info) { return 0; }

unsigned int fileio_ferror(fileio_info_t *info) { return 0; }
...
int fsdevice_limit_namelength(vdrive_t *vdrive, uint8_t *name) { return 0; }
...
int disk_image_close(disk_image_t *image) { return 0; }

void disk_image_destroy(disk_image_t *image) {}

disk_image_t *disk_image_create(void) { return NULL; }

int disk_image_open(disk_image_t *image) { return 0; }
...
int disk_image_fsimage_create(const char *name, unsigned int type) { return 0; }

int disk_image_fsimage_create_dxm(const char *name, const char *dname,
                                  unsigned int type) {
  return 0;
}

int disk_image_fsimage_create_dhd(const char *name, const char *dname,
                                  unsigned int type) {
  return 0;
}
...
const char *disk_image_name_get(const disk_image_t *image) { return NULL; }
...
int disk_image_write_p64_image(const disk_image_t *image) { return 0; }
...
void *disk_image_fsimage_fd_get(const disk_image_t *image) { return NULL; }
...
unsigned int machine_bus_device_type_get(unsigned int unit) { return 0; }
...
void machine_bus_status_trapdevices_set(unsigned int unit,
                                        unsigned int enable) {}
...
int iecbus_device_write(unsigned int unit, uint8_t data) { return 0; }

uint8_t iecbus_device_read(void) { return 0; }
...
int drive_num_leds(unsigned int dnr) { return 1; }
...
int drive_get_disk_drive_type(int dnr) { return 0; }

int drive_is_dualdrive_by_devnr(int devnr) { return 0; }

int drive_get_type_by_devnr(int devnr) { return 0; }
...
int vdrive_device_setup(vdrive_t *vdrive, unsigned int unit) { return 0; }

void vdrive_device_shutdown(vdrive_t *vdrive) {}

int vdrive_iec_attach(unsigned int unit, const char *name) { return 0; }
...
int vdrive_iec_close(vdrive_t *vdrive, unsigned int secondary) { return 0; }
...
int tapeport_device_register(int id, tapeport_device_t *device) { return 0; }
...
int tap_seek_to_offset(tap_t *tap, unsigned long offset) { return 0; }

int iec_available_busses(void) { return 0; }

int machine_get_num_keyboard_types(void) { return 0; }

kbdtype_info_t *machine_get_keyboard_info_list(void) { return NULL; }

void drive_cpu_trigger_reset_button(unsigned int dnr, unsigned int button) {}

int drive_has_buttons(unsigned int dnr) { return 0; }

int drive_image_type_to_drive_type(unsigned int type) { return 0; }

unsigned int drive_check_dual(unsigned int type) { return 0; }

unsigned int drive_get_num_heads(unsigned int type) { return 0; }

unsigned int drive_get_half_tracks(unsigned int type) { return 0; }

bool drive_is_jammed(int mynumber) { return false; }

char *drive_jam_reason(int mynumber) { return NULL; }

userport_desc_t *userport_get_valid_devices(int sort) { return NULL; }

const char *userport_get_device_type_desc(int type) { return NULL; }

#if !defined(USE_SDLUI) && !defined(USE_SDL2UI)
tapeport_desc_t *tapeport_get_valid_devices(int port, int sort) { return NULL; }

const char *tapeport_get_device_type_desc(int type) { return NULL; }
#endif

uint8_t userport_io_sim_get_pbx_out_lines(void) { return 0; }

void userport_io_sim_set_pbx_out_lines(uint8_t val) {}

int userport_device_register(int id, userport_device_t *device) { return -1; }

bool pia1_get_diagnostic_pin(void) { return false; }

#ifdef HAVE_LIBCURL
const tzones_t *userport_wic64_get_timezones(size_t *num_zones) { return NULL; }
...
sampler_device_t *sampler_get_devices(void) { return NULL; }

void sampler_stop(void) {}

void sampler_start(int channels, char *devname) {}

uint8_t sampler_get_sample(int channel) { return 0; }

/*******************************************************************************
 *  Printer                                                                    *
 ******************************************************************************/

const driver_select_list_t *driver_select_get_drivers(void) { return NULL; }

bool driver_select_is_printer(const char *drv_name) { return false; }

bool driver_select_is_plotter(const char *drv_name) { return false; }

bool driver_select_has_iec_bus(const char *drv_name) { return false; }

bool driver_select_has_ieee488_bus(const char *drv_name) { return false; }

bool driver_select_has_userport(const char *drv_name) { return false; }

bool driver_select_has_text_output(const char *drv_name) { return false; }

bool driver_select_has_graphics_output(const char *drv_name) { return false; }
...
uint8_t c64_diag_586220_read_joyport_dig(uint8_t port) { return 0; }

uint8_t c64_diag_586220_read_joyport_pot(void) { return 0; }
#endif
...
int userport_get_device(void) { return 0; }
